...
def main():
    ...
    addProduto = Button(root, text="Adicionar Produto", background="#808080", foreground="black")
    ...
    edit = Button(root, text="Fazer Compra", background="#808080", foreground="black")
